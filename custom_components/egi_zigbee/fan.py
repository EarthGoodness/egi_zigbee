...
from homeassistant.components.fan.const import SPEED_LOW, SPEED_MEDIUM, SPEED_HIGH, SPEED_OFF, SPEED_AUTO

from .const import DP_POWER, DP_FAN, FAN_MAP
...
async def async_setup_entry(hass, entry, async_add_entities):
    """Set up FanEntities for all paired EGI Zigbee devices."""
    entities = []
